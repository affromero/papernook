...
export default async function SettingsPage() {
  ...
  return profilePageFiles(capability, () => {
    const state = sharedAccess().identity.readSnapshot();
    ...
    const selected = authenticated.principal
      ...
      : sharedAccess().profiles.selectedFromState(state.access, admission.token)
          ?.id;
    if (selected !== capability.username) redirect("/settings");
            ...
            <div className={styles.content}>
              ...
              <section className={styles.section} id="capture">
                ...
                <div className={styles.setupList}>
                  ...
                  <article className={styles.setupItem}>
                    ...
                    <details className={styles.manualSetup}>
                      ...
                      <ol>
                        <li>
                          Add <strong>Receive input from Share Sheet</strong>{" "}
                          with the input type set to URLs.
                        </li>
                        <li>
                ...
                <details className={styles.secretPanel}>
                  ...
                  <div>
                    ...
                    <p>
                      Private to {profile.displayName}. Anyone with this token
                      can add papers as you.
                    </p>
                  </div>
                </details>
              </section>
              ...
              <section className={styles.section} id="canvas">
                <div className={styles.sectionHeader}>
                  ...
                  <div>
                    <h2>Canvas</h2>
                    <p>
                      Enable visual notes, screenshots, links, and diagrams
                      beside papers.
                    </p>
                  </div>
                </div>
              ...
              <section className={styles.section} id="people">
                ...
                {admin && (
                  <div className={styles.subsection}>
                    <h3>Members</h3>
                    <p>
                      You manage instance configuration. Members choose their
                      name and avatar.
                    </p>
                    <AdminMembers
                      members={state.profiles
                        .map((profile) =>
                          toPublicProfile(
                            profile,
              ...
              <section className={styles.section} id="devices">
                ...
                <div className={styles.subsection}>
                  ...
                  <p>
                    Scan while connected through Tailscale or the same Wi-Fi.
                  </p>
                ...
                {webdavUrl && (
                  <details className={`${styles.subsection} ${styles.webdav}`}>
                    ...
                    <p>
                      Optional WebDAV access for apps that edit the PDF
                      directly.
                    </p>
